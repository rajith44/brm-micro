...
export default function ColoredGemstonesCarousel() {
  ...
  return (
    <div className="gemSwiper relative w-full min-w-0">
      <Swiper
        spaceBetween={20}
        slidesPerView={2.2}
        onSwiper={(s) => {
          ...
          <SwiperSlide key={g.slug} className="h-auto pb-2 pt-2">
            ...
            >
              ...
              <div className="p-4 text-center">
                <h3 className="font-cormorant text-xl">{g.name}</h3>
                <p className="text-sm mt-1 text-[#6a5844] group-hover:text-gold transition-colors">View more</p>
              </div>
            </Link>
          </SwiperSlide>
        ))}
