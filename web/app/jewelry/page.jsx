...
export const metadata = {
  title: "Jewelry Categories — Prestige Gems",
      ...
      <section className="max-w-7xl mx-auto px-4 lg:px-8 py-14">
        <div className="flex items-center justify-between mb-8">
          <p className="text-[#6a5844]">
            ...
            <span className="font-semibold text-ink">{total}</span> pieces
          </p>
          <Link href="/jewelry/all" className="text-gold hover:text-gold-bright underline text-sm">
            View all jewelry →
          </Link>
        </div>
